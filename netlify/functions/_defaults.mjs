export const defaultState = {
  settings: {
    ...
    welcomeTitle: "Bienvenido a Salta Soluciones",
    welcomeText: "Encontrá profesionales y servicios de confianza en un solo lugar. Elegí al profesional que mejor se adapte a vos y contactalo directamente. Si necesitás orientación, también podés hablar con Salta Soluciones.",
    servicesTitle: "Servicios disponibles",
    servicesSubtitle: "Elegí el servicio que necesitás para ver profesionales disponibles.",
    heroStart: "#061f43",
    heroEnd: "#0a4b8f",
    titleColor: "#ffffff",
